          ...
          <div className="bg-white p-6 rounded-xl w-80 shadow-lg">
            ...
            <div className="flex gap-2">
              <button
                ...
                className={`flex-1 py-2 rounded-lg ${updatingPassword ? "bg-gray-300 text-gray-500 cursor-not-allowed"
          ...
          <div className="bg-white rounded-xl shadow-sm p-5 flex justify-between items-center">
            <div className="">
              ...
              {notificationEnabled ? <div className="text-sm text-gray-500">
                ...
                <href
                  onClick={() => {
                    window.open("/liveNotifications",
                      "LiveNotifications", "width=600,height=600,resizable=yes,scrollbars=yes");
                  }}
